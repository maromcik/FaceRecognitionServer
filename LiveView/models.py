...
class Setting(models.Model):
    ...
    stream1 = "rtsp://192.168.1.16/user=admin&password=&channel=1&stream=0.sdp?real_stream"
    ...
    stream5 = "http://192.168.1.65:8080/video"
    DEVICE_CHOICES = (
        (stream1, 'New gate camera'),
        (stream2, 'Gate camera'),
        (stream3, 'S7 Edge camera'),
        (stream4, 'A5 camera'),
        (stream5, 'S10-P camera'),
    )
